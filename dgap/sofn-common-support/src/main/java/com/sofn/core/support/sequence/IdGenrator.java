package com.sofn.core.support.sequence;
...
public class IdGenrator {
     ...
     */
    public IdGenrator(long idepoch) {
     ...
     */
    public IdGenrator(long workerId, long datacenterId) {
     ...
     */
    public IdGenrator(long workerId, long datacenterId, long sequence) {
     ...
     * @param idepoch 毫秒级时间(41位)
     */
    public IdGenrator(long workerId, long datacenterId, long sequence, long idepoch) {
