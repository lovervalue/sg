...
public class DfdjAnimalData {
    ...
    public void setSyldw(String syldw) {
        this.syldw = syldw == null ? null : syldw.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        DfdjAnimalData other = (DfdjAnimalData) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSyldw() == null ? other.getSyldw() == null : this.getSyldw().equals(other.getSyldw()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSyldw() == null) ? 0 : getSyldw().hashCode());
