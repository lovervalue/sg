angular.module("myapp",[]).controller("qryTaskReportList",function($scope,$http,$state){
    ...
    var loadGrid = function () {$("#grid").dataTable({
        ajax : {
    ...
    window.querySampleJcInfoList = function(o,p){
        window.localStorage.removeItem("asms_Check_Task_ReportList_SampleInfoList");
