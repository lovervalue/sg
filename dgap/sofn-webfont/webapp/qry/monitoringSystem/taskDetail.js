...
myapp.controller("taskDetail",function($scope,$http,$state) {
    ...
    $http({
        ...
        if(data.adsMonitorTask[0].checkObject!=null){
            ...
            $scope.detail.checkObject=$scope.detail.checkObject.replace("null、", "");
            $scope.detail.checkObject=$scope.detail.checkObject.replace("null", "");
        }
        if($scope.detail.checkObject ==null || $scope.detail.checkObject=="null") {
            $scope.detail.checkObject = "";
        }
       if(data.adsMonitorTask[0].checkProject!=null){
           project=data.adsMonitorTask[0].checkProject.split("、").length;
           $scope.detail.checkProject=$scope.detail.checkProject.replace("null、", "");
           $scope.detail.checkProject=$scope.detail.checkProject.replace("null", "");
       }
       if($scope.detail.checkProject ==null || $scope.detail.checkProject=="null") {
           $scope.detail.checkProject = "";
        }
  ...
  //返回键
     ...
     */
    $http({
        url:"/sofn-qry-web/adsMonitorTask/getPageInfoByMonitorTask",
        method:"post",
        dataType:"json",
    ...
    $scope.downloadFile=function(){
        console.log($scope.detail.attachment);
