...
myapp.controller("trace", function ($scope, $http, $state) {
    ...
    window.queryByTrace = function (zsm) {
        $.ajax({
            url: "/sofn-qry-web/zsm/zsmIsCgOrXs",
            type: 'POST',//POST方式
    ...
    window.isXsZs = function (zsm) {
        $.ajax({
            url: "/sofn-qry-web/zsm/existsTrace",
            type: 'POST',//POST方式
            dataType: 'json',//返回json类型
            data: {
                zsm: zsm,
    ...
    window.cgdown = function () {
        ...
        $("#zs_grid").dataTable({
            ajax: {
                url: "/sofn-qry-web/zsm/getDownZsm",
    ...
    window.cgbase = function (zsm) {
        $.ajax({
            url: "/sofn-qry-web/zsm/getBaseZsm",
            type: 'POST',//POST方式
            dataType: 'json',//返回json类型
            data: {
                zsm: zsm
    ...
    window.xsup = function () {
        ...
        $("#upgrid").dataTable({
            ajax: {
                url: "/sofn-qry-web/zsm/getXsUpZsm",
                dataSrc: function (json) {
                    json.recordsTotal = json.data.total;//总个数
                    json.recordsFiltered = json.data.total;
                    json.pageNumber = json.data.pageNum;//页码
    ...
    window.xsbase = function () {
        ...
        $("#basegrid").dataTable({
            ajax: {
                url: "/sofn-qry-web/zsm/getXsbaseZsm",
                dataSrc: function (json) {
                    json.recordsTotal = json.data.total;//总个数
                    json.recordsFiltered = json.data.total;
                    json.pageNumber = json.data.pageNum;//页码
    ...
    window.getUpPc = function (fromzsm, status, billStratrus) {
        ...
        $("#up_grid").dataTable({
            ajax: {
                url: "/sofn-qry-web/zsm/getTopForPc",
                dataSrc: function (json) {
                    json.recordsTotal = json.data.total;//总个数
                    json.recordsFiltered = json.data.total;
                    json.pageNumber = json.data.pageNum;//页码
    ...
    window.getBasePc = function (zsm) {
        $.ajax({
            url: "/sofn-qry-web/zsm/getBaseForPc",
            type: 'POST',//POST方式
            dataType: 'json',//返回json类型
            data: {
                pc: zsm,
    ...
    window.downPc = function () {
        ...
        $("#grid").dataTable({
            ajax: {
                url: "/sofn-qry-web/pc/getDownForPc",
                dataSrc: function (json) {
                    json.recordsTotal = json.data.total;//总个数
                    json.recordsFiltered = json.data.total;
                    json.pageNumber = json.data.pageNum;//页码
