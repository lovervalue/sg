var myapp = angular.module("myapp", []).controller("qryCheckProject_new", function ($scope, $http, $state) {
//地区
    ...
    $scope.reloadArea = function () {
        ...
        $("checkbox[name='result']").prop("checked",false);
...
//产品摸态框
    ...
    $scope.exportExcel = function () {
        ...
        var submit = function (v, h, f) {
            if (v == true)
                $http({
                    url: "/sofn-qry-web/checkProject/getCheckList",
                    method: "post",
                    dataType: "json",
