...
myapp.controller("qrySubjEntPrint",function($scope,$http,$state){
    ...
    $scope.exportData = function(){
        ...
        input7.attr('name', 'dateBegin');
        input7.attr('value', $("input[name='dateBegin']").val());
        var input8 = $('<input>');
        input8.attr('type', 'hidden');
        input8.attr('name', 'dateEnd');
        input8.attr('value', $("input[name='dateEnd']").val());
        $('body').append(form);
        form.append(input1);
        form.append(input2);
        form.append(input3);
