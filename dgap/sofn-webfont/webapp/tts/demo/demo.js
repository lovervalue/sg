...
myapp.controller("demo",function($scope,$http,$state){
...
//        选择栏背景颜色变化
    ...
    $(function() {
        ...
        $("#grid").dataTable({
            ...
            autoWidth : false,
            ajax : {
                url : "/sofn-tts-web/testDemo/getPageInfo",
            ...
            columns : [
                ...
                },
                {
                    ...
                    render : function(data, type, row) { 
                        ...
                        var update_a = '<a href="#/baseInspectionUpdate" style="margin-right: 10px;cursor: pointer" onclick="updateData(\''+data+'\')">修改</a>';
    ...
    window.lookView=function(data){
        ...
        $state.go("index.content.tts/demo/demoView")
    }
    ...
    window.updateData = function(data){
        window.localStorage.setItem("id",data);
        $state.go("index.content.tts/demo/demoUpdate")
    }
    ...
    window.deleteData = function(data){
    	...
    	{
    		$.ajax({
                url:"/sofn-tts-web/testDemo/deleteTempDemo",
                type:"post",
                dataType:"json",
                data:{id:data},
