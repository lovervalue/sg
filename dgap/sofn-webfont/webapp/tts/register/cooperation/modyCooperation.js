...
var myapp = angular.module("myapp", []).controller("modyCooperation", function ($scope, $http, $state) {
    //导航对齐
    ...
    function query111(){
        ...
        if (crad == "independent") {
            ...
            if(code.length !=18){
                $("#creditCode").css("border-color", "#a94442").css("box-shadow", "inset 0 1px 1px rgba(0,0,0,.075),0 0 6px #ce8483")
                $scope.flag = true;
                $("#msg").css("display", "block").html("企业工商注册号为18位");
                return;
            }
            if (code.length != 18 || !(code.match('^[A-Za-z0-9]+$'))) {
                $("#creditCode").css("border-color", "#a94442").css("box-shadow", "inset 0 1px 1px rgba(0,0,0,.075),0 0 6px #ce8483")
            ...
            if(code.length !=10){
                $("#creditCode").css("border-color", "#a94442").css("box-shadow", "inset 0 1px 1px rgba(0,0,0,.075),0 0 6px #ce8483")
                $scope.flag = true;
                $("#msg").css("display", "block").html("企业工商注册号为10位");
                return;
            }
            if (!(/^[0-9a-zA-Z]{8}-[0-9a-zA-Z]{1}$/.test(code))) {
                $("#creditCode").css("border-color", "#a94442").css("box-shadow", "inset 0 1px 1px rgba(0,0,0,.075),0 0 6px #ce8483");
    ...
    $scope.cooperationNextStep = function () {
        ...
        //图片信息验证
        if(radioId && "independent" == radioId){
