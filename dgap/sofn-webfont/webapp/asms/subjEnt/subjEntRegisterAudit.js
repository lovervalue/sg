var myapp=angular.module("myapp",[]).controller("subjEntRegisterAudit",function($scope,$http,$state){

    //获取本地存储的ID
    $scope.subjEntRegisterId=window.localStorage.getItem("subjEntRegisterId");
    ...
    $http({
        ...
        method:"post",
        data:{id:$scope.subjEntRegisterId}
    ...
    $scope.removeLocalStorage=function(){
        ...
        $state.go("index.content.asms/subjEnt/subjEntRegisterList");
    }

    //审核生产经营主体备案申请
    $scope.auditSubjEntRegister=function(auditState){
        ...
        $http({
            ...
            url:"/sofn-asms-web/subjEnt/auditSubjEntRegister",
            method:"post",
            data:$scope.subjEnt
        }).success(function(data){
