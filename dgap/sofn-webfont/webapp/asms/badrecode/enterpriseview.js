        ...
        if(dataEnterprise.enterprise==null||dataEnterprise.enterprise==""||dataEnterprise.enterprise==undefined){
            $http({
                ...
                if ($scope.subjEntTemp.positiveIdcardeimg) {
                    $("#positiveIdcardeimgL").append('<a data-fancybox href="'+$scope.subjEntTemp.positiveIdcardeimg+'"> <img class="ml15" style="height: 120px;width: 200px;" src="' + $scope.subjEntTemp.positiveIdcardeimg + '" alt=""/> </a>');
                }else {
                    $("#positiveIdcardeimgL").append("<span>无</span>");
                }
                if ($scope.subjEntTemp.negativeIdcardimg) {
                    $("#negativeIdcardimgL").append('<a data-fancybox href="'+$scope.subjEntTemp.negativeIdcardimg+'"> <img class="ml15" style="height: 120px;width: 200px;" src="' + $scope.subjEntTemp.negativeIdcardimg + '" alt=""/> </a>');
                }else {
                    $("#negativeIdcardimgL").append("<span>无</span>");
                }
                if ($scope.subjEntTemp.handIdcardimg) {
                    $("#handIdcardimgL").append('<a data-fancybox href="'+$scope.subjEntTemp.handIdcardimg+'"> <img class="ml15" style="height: 120px;width: 200px;" src="' + $scope.subjEntTemp.handIdcardimg + '" alt=""/> </a>');
                }else {
                    $("#handIdcardimgL").append("<span>无</span>");
                }
