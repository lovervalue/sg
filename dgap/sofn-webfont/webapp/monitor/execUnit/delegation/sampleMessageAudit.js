...
myapp.controller("sampleMessageAudit", function ($scope, $http, $state) {
    ...
    $scope.routineMonitorList = function (data) {
        $state.go("index.content.monitor/execUnit/delegation/routineMonitorListAudit")
    }
...
//抽样机构下拉选
    ...
    $scope.downloadSample = function (data) {
        $state.go("index.content.monitor/execUnit/delegation/downloadsample")

    }
    $scope.sampleMessage = function (data) {
        $state.go("index.content.monitor/execUnit/delegation/sampleMessageAudit")
    }
