...
myapp.controller("delegationTestList",function($scope,$http,$state){
    ...
    $scope.delegationTestEnabled = true;
    /**
     * 分页展示数据
     */
    $(function() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(myData.publishStatus == "5")
                    $scope.delegationTestEnabled = false;
                else
                    $scope.delegationTestEnabled = true;
    ...
    window.add=function(){
        ...
        $state.go("index.content.monitor/execUnit/delegation/delegationTest")
    }
