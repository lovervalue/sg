...
myapp.controller("sampleCodePrint", function ($scope, $http, $state) {
    $scope.sampleCode = window.localStorage.getItem("adsTaskSampleSampleCode");//样品编号
    $scope.entrustTaskName = window.localStorage.getItem("adsTaskEntrustTaskName_iskey");//任务名称
