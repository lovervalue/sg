...
myapp.controller("routineMonitorList",function($scope,$http,$state){
        ...
        $.ajax({
            ...
            success:function(datax){
                if("专项监测"==monitorClass){
                    $("#daohang").empty();
                    var Row = '<a href="#" ui-sref="index.content.monitor/execUnit/specialMonitor/routineMonitoringSpecial">专项监测</a>&gt;<span>检测</span>';
                    $("#daohang").html(Row);
                }
