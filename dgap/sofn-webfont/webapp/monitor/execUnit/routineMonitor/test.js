...
myapp.controller("test",function($scope,$http,$state){
            ...
            columns : [
                ...
                },
                {
                    ...
                    render : function(data, type, row,meta) { // 模板化列显示内容
                        if(" " == data){
                            return '<input id="'+meta.row+'" placeholder="ND" type="text" name="wu" class="Sup_contain_section_contain_input" onblur="my123('+meta.row+","+row.judgeNum+');check(this)"/>';
                        }else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(""==myData.after && ""==myData.before){
                    Row2 = '<div style="float: left;">样品编码 <span><input value="'+myData.yangp+'" type="text" name="myName" class="Sup_contain_section_contain_input gui-input"/></span></div>&nbsp;&nbsp;'+
                ...
                $("#myinfo").empty();
                Row3 = '<div style="float: left;"><span>样品名称  '+myData.sampleName+' </span>&nbsp;&nbsp;'+
    ...
    window.before=function(id){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var Row2 = "";
                if(""==myData.before){
                    Row2 = '<div style="float: left;">样品编码 <span><input value="'+myData.yangp+'" type="text" name="myName" class="Sup_contain_section_contain_input gui-input"/></span></div>&nbsp;&nbsp'+
                        // '<button onclick="find2()">查询</button>&nbsp;&nbsp;'+
                        '<span class="gui-btn" id="after" disabled="true">上一个样品</span>&nbsp;&nbsp;'+
                        '<span class="gui-btn" type="button" onclick="next('+"'"+myData.after+"'"+')" id="next">下一个样品</span>&nbsp;&nbsp;'+
                        '<span class="gui-btn" type="button" onclick="back()">返回</span>&nbsp;&nbsp;'+
