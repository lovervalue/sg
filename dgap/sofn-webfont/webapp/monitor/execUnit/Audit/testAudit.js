...
myapp.controller("testAudit", function ($scope, $http, $state) {
    ...
    $(function () {
        ...
        $("#mygrid").dataTable({
            ...
            ajax: {
                ...
                url: "/sofn-ads-web/adsCheckInfo/getTestItemForB",
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) { // 模板化列显示内容
                        if (" " == data) {
                            return '<input id="' + meta.row + '"placeholder="ND" type="text" name="wu" class="Sup_contain_section_contain_input gui-input" onblur="my123(' + meta.row + "," + row.judgeNum +  ",'" + row.id + "'" +');check(this)"/>';
                        } else {
