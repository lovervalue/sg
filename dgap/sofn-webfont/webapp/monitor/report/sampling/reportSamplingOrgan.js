...
myapp.controller("reportSamplingOrgan",function($scope,$http,$state){
    ...
    $(function() {
        ...
        $("#grid").dataTable({
            ajax : {
                url:"/sofn-ads-web/adsReport/getSamplingOrganReportPageInfo",
    ...
    $scope.loadReportCharts = function(data){
        ...
        $(data).each(function () {
            var a = $(this)[0];
            category.push(a.SAMPLE_DEPARMENT);
    ...
    $scope.exportExcel = function () {
        ...
        var submit = function (v, h, f) {
            if (v == true){
                ...
                $http({
                    url:"/sofn-ads-web/adsReport/exportSamplingOrganExcel",
                    method:"post",
                    dataType:"json",
                    params : {"monitorTaskId":monitorTaskId},
                    ...
                    if(blob.size > 0){
                        ...
                        a.setAttribute('download', taskName + '抽样机构报表.xls');
                        a.click();
                    }else{
