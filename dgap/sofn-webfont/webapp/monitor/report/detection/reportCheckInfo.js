...
myapp.controller("reportCheckInfo",function($scope,$http,$state){
    ...
    $scope.loadReportTable=function (id) {
        $("#grid").dataTable({
            ajax : {
                ...
                url : "/sofn-ads-web/adsReport/getCheckInfoReportPageInfo",
    ...
    $scope.exportExcel = function () {
        ...
        var submit = function (v, h, f) {
            if (v == true){
                ...
                $http({
                    url:"/sofn-ads-web/adsReport/exportCheckInfoExcel",
                    method:"post",
                    dataType:"json",
                    ...
                    if(blob.size > 0){
                        ...
                        a.setAttribute('download', taskName + '检测项目报表.xls');
                        a.click();
                    }else{
