...
myapp.controller("reportCheckArea",function($scope,$http,$state){
    ...
    $(function() {
        ...
        $("#grid").dataTable({
            ajax : {
                ...
                url:"/sofn-ads-web/adsReport/getCheckAreaReportPageInfo",
    ...
    $scope.exportExcel = function () {
        ...
        var submit = function (v, h, f) {
            if (v == true){
                ...
                $http({
                    url:"/sofn-ads-web/adsReport/exportCheckAreaExcel",
                    method:"post",
                    dataType:"json",
                    params : {"monitorTaskId":monitorTaskId},
                    ...
                    if(blob.size > 0){
                        ...
                        a.setAttribute('download', taskName + '检测地区报表.xls');
                        a.click();
                    }else{
