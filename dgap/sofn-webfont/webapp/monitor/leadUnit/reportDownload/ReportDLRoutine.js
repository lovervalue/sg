...
myapp.controller("ReportDLRoutine", function ($scope, $http, $state) {
    ...
    $(function () {
        ...
        $("#grid").dataTable({
            ajax: {
                ...
                url: "/sofn-ads-web/adsFile/getDlReportPage",
        ...
        $http({
            ...
            method:"post",
            dataType:"json",
            params : {folder:"no",monitorType:"例行监测",source:"承担单位",token:token},
