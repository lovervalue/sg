...
myapp.controller("adsModelSampleLink",function($scope,$http,$state){
    ...
    $(function() {
        ...
        $("#grid").dataTable({
            ajax : {
                url : "/sofn-sys-web/adsModelSampleLink/getPageInfoAll",
    ...
    window.delAdsModelSampleLink=function () {
        ...
        if(check.length > 0){
            ...
            var submit = function (v, h, f) {
                if (v == true)
                    $.ajax({
                        url:"/sofn-sys-web/adsModelSampleLink/delAdsModelSampleLink",
                        type:"post",
                        dataType:"json",
    ...
    $scope.addAdsModelSampleLink = function(){
        ...
        var name = $("#name").val();
        $.ajax({
            url:"/sofn-sys-web/adsModelSampleLink/addAdsModelSampleLink",
            type:"post",
            dataType:"json",
    ...
    $scope.updateAdsModel = function(){
        ...
        var name = $("#nameU").val();
        $.ajax({
            url:"/sofn-sys-web/adsModelSampleLink/updateAdsModelSampleLink",
            type:"post",
            dataType:"json",
    ...
    window.deleteAdsModelSampleLink = function (id) {
        ...
        var submit = function (v, h, f) {
            if (v == true)
                $.ajax({
                    url:"/sofn-sys-web/adsModelSampleLink/deleteAdsModelSampleLink",
                    type:"post",
                    dataType:"json",
