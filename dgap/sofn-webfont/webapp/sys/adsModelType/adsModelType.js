...
myapp.controller("adsModelType",function($scope,$http,$state){
    ...
    $(function() {
        ...
        $("#grid").dataTable({
            ajax : {
                url : "/sofn-sys-web/adsModelType/getPageInfoAll",
    ...
    window.delAdsModelType=function () {
        ...
        if(check.length > 0){
            ...
            var submit = function (v, h, f) {
                if (v == true)
                    $.ajax({
                        url:"/sofn-sys-web/adsModelType/delAdsModelType",
                        type:"post",
                        dataType:"json",
    ...
    $scope.addAdsModelType = function(){
        ...
        var name = $("#name").val();
        $.ajax({
            url:"/sofn-sys-web/adsModelType/addAdsModelType",
            type:"post",
            dataType:"json",
    ...
    $scope.updateAdsModel = function(){
        ...
        var name = $("#nameU").val();
        $.ajax({
            url:"/sofn-sys-web/adsModelType/updateAdsModelType",
            type:"post",
            dataType:"json",
    ...
    window.deleteAdsModelType = function (id) {
        ...
        var submit = function (v, h, f) {
            if (v == true)
                $.ajax({
                    url:"/sofn-sys-web/adsModelType/deleteAdsModelType",
                    type:"post",
                    dataType:"json",
