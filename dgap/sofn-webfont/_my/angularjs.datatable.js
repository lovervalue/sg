    ...
    return {
        ...
        link: function ($scope, $elem, attrs) {
            ...
            options.aoColumns = [
                ...
                { "mData": "INSPECTION_USER_NAME",
                "title":"胖子",
                    render : function(data, type, row) { // 模板化列显示内容
                        return '<a href="#/baseInspectionView" style="margin-right: 10px;cursor: pointer" class="Check-report"  onclick="Checkreport(\''+data+'\')">查看</a><a href="#/baseInspectionUpdate" style="margin-right: 10px;cursor: pointer" onclick="gotoUpdateBaseInspection(\''+data+'\')">修改</a><a style="cursor: pointer" onclick="deleteBaseInspection(\''+data+'\')">删除</a>';//转义传值
                    }},
            ];
