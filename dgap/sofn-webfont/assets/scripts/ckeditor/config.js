...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserImageUploadUrl = '/sofn-sys-web/document/ckeditorupload';
    config.imageUploadUrl = '/sofn-sys-web/document/upload';
    config.language = 'zh-cn';
    config.font_names = config.font_names + ";黑体/SimHei;宋体/SimSun;新宋体/NSimSun;仿宋/FangSong;楷体/KaiTi;微软雅黑/'Microsoft YaHei';微软正黑体/'Microsoft JhengHei';";
...
/*    config.toolbar = [
    ...
    config.contentsCss = [ '../../../../assets/scripts/ckeditor/contents.css' ];
