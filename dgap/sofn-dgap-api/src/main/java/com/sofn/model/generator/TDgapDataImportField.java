...
public class TDgapDataImportField extends BaseModel {
    ...
    private String dataImportTableId;
    ...
    public String getDataImportTableId() {
        return dataImportTableId;
    }

    public void setDataImportTableId(String dataImportTableId) {
        this.dataImportTableId = dataImportTableId == null ? null : dataImportTableId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", dataImportTableId=").append(dataImportTableId);
    ...
    public boolean equals(Object that) {
        ...
        TDgapDataImportField other = (TDgapDataImportField) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getDataImportTableId() == null ? other.getDataImportTableId() == null : this.getDataImportTableId().equals(other.getDataImportTableId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDataImportTableId() == null) ? 0 : getDataImportTableId().hashCode());
