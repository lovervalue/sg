...
public class TDgapAlertLog extends BaseModel {
    ...
    public void setAlertConfigId(String alertConfigId) {
        this.alertConfigId = alertConfigId == null ? null : alertConfigId.trim();
    }
    ...
    public void setSolveUserId(String solveUserId) {
        this.solveUserId = solveUserId == null ? null : solveUserId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", alertConfigId=").append(alertConfigId);
        sb.append(", targetId=").append(targetId);
        sb.append(", description=").append(description);
        sb.append(", alertDate=").append(alertDate);
        sb.append(", solveDate=").append(solveDate);
        sb.append(", solveUserId=").append(solveUserId);
    ...
    public boolean equals(Object that) {
        ...
        TDgapAlertLog other = (TDgapAlertLog) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getAlertConfigId() == null ? other.getAlertConfigId() == null : this.getAlertConfigId().equals(other.getAlertConfigId()))
            ...
            && (this.getSolveDate() == null ? other.getSolveDate() == null : this.getSolveDate().equals(other.getSolveDate()))
            && (this.getSolveUserId() == null ? other.getSolveUserId() == null : this.getSolveUserId().equals(other.getSolveUserId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAlertConfigId() == null) ? 0 : getAlertConfigId().hashCode());
        result = prime * result + ((getTargetId() == null) ? 0 : getTargetId().hashCode());
        result = prime * result + ((getDescription() == null) ? 0 : getDescription().hashCode());
        result = prime * result + ((getAlertDate() == null) ? 0 : getAlertDate().hashCode());
        result = prime * result + ((getSolveDate() == null) ? 0 : getSolveDate().hashCode());
        result = prime * result + ((getSolveUserId() == null) ? 0 : getSolveUserId().hashCode());
