...
public class TDgapTbResourceConfig extends BaseModel {
    ...
    public String toString() {
        ...
        sb.append(", tableCnName=").append(tableCnName);
    ...
    public boolean equals(Object that) {
        ...
        TDgapTbResourceConfig other = (TDgapTbResourceConfig) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getResourceId() == null ? other.getResourceId() == null : this.getResourceId().equals(other.getResourceId()))
            && (this.getTableName() == null ? other.getTableName() == null : this.getTableName().equals(other.getTableName()))
            && (this.getTableCnName() == null ? other.getTableCnName() == null : this.getTableCnName().equals(other.getTableCnName()))
            && (this.getFieldName() == null ? other.getFieldName() == null : this.getFieldName().equals(other.getFieldName()))
            && (this.getFieldCnName() == null ? other.getFieldCnName() == null : this.getFieldCnName().equals(other.getFieldCnName()))
            && (this.getLength() == null ? other.getLength() == null : this.getLength().equals(other.getLength()))
            && (this.getType() == null ? other.getType() == null : this.getType().equals(other.getType()))
            && (this.getIsCondition() == null ? other.getIsCondition() == null : this.getIsCondition().equals(other.getIsCondition()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTableCnName() == null) ? 0 : getTableCnName().hashCode());
        result = prime * result + ((getFieldName() == null) ? 0 : getFieldName().hashCode());
        result = prime * result + ((getFieldCnName() == null) ? 0 : getFieldCnName().hashCode());
        result = prime * result + ((getLength() == null) ? 0 : getLength().hashCode());
        result = prime * result + ((getType() == null) ? 0 : getType().hashCode());
        result = prime * result + ((getIsCondition() == null) ? 0 : getIsCondition().hashCode());
