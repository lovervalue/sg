...
public class TDgapWsErrorLog extends BaseModel {
    ...
    public void setResourceDirectoryId(String resourceDirectoryId) {
        this.resourceDirectoryId = resourceDirectoryId == null ? null : resourceDirectoryId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", resourceDirectoryId=").append(resourceDirectoryId);
    ...
    public boolean equals(Object that) {
        ...
        TDgapWsErrorLog other = (TDgapWsErrorLog) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getResourceDirectoryId() == null ? other.getResourceDirectoryId() == null : this.getResourceDirectoryId().equals(other.getResourceDirectoryId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getResourceDirectoryId() == null) ? 0 : getResourceDirectoryId().hashCode());
