...
public class TDgapWsDailyStat extends BaseModel {
    ...
    private BigDecimal avgTimecost;
    ...
    public void setWebServiceId(String webServiceId) {
        this.webServiceId = webServiceId == null ? null : webServiceId.trim();
    }
    ...
    public void setWebServiceName(String webServiceName) {
        this.webServiceName = webServiceName == null ? null : webServiceName.trim();
    }
    ...
    public void setBussnessName(String bussnessName) {
        this.bussnessName = bussnessName == null ? null : bussnessName.trim();
    }
    ...
    public void setCallerUser(String callerUser) {
        this.callerUser = callerUser == null ? null : callerUser.trim();
    }
    ...
    public BigDecimal getAvgTimecost() {
        return avgTimecost;
    }

    public void setAvgTimecost(BigDecimal avgTimecost) {
    ...
    public String toString() {
        ...
        sb.append(", webServiceId=").append(webServiceId);
        sb.append(", webServiceName=").append(webServiceName);
        sb.append(", bussnessName=").append(bussnessName);
        sb.append(", callerUser=").append(callerUser);
        sb.append(", successTimes=").append(successTimes);
        sb.append(", failTimes=").append(failTimes);
        sb.append(", avgTimecost=").append(avgTimecost);
    ...
    public boolean equals(Object that) {
        ...
        TDgapWsDailyStat other = (TDgapWsDailyStat) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getStatDate() == null ? other.getStatDate() == null : this.getStatDate().equals(other.getStatDate()))
            && (this.getResourceDir() == null ? other.getResourceDir() == null : this.getResourceDir().equals(other.getResourceDir()))
            && (this.getWebServiceId() == null ? other.getWebServiceId() == null : this.getWebServiceId().equals(other.getWebServiceId()))
            && (this.getWebServiceName() == null ? other.getWebServiceName() == null : this.getWebServiceName().equals(other.getWebServiceName()))
            && (this.getBussnessName() == null ? other.getBussnessName() == null : this.getBussnessName().equals(other.getBussnessName()))
            && (this.getCallerUser() == null ? other.getCallerUser() == null : this.getCallerUser().equals(other.getCallerUser()))
            ...
            && (this.getAvgTimecost() == null ? other.getAvgTimecost() == null : this.getAvgTimecost().equals(other.getAvgTimecost()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getResourceDir() == null) ? 0 : getResourceDir().hashCode());
        ...
        result = prime * result + ((getBussnessName() == null) ? 0 : getBussnessName().hashCode());
        result = prime * result + ((getCallerUser() == null) ? 0 : getCallerUser().hashCode());
        ...
        result = prime * result + ((getAvgTimecost() == null) ? 0 : getAvgTimecost().hashCode());
