...
public class TDgapAlertConfig extends BaseModel {
    ...
    public String getNeedSendAlert() {
        return needSendAlert;
    }

    public void setNeedSendAlert(String needSendAlert) {
        this.needSendAlert = needSendAlert == null ? null : needSendAlert.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", needSendAlert=").append(needSendAlert);
    ...
    public boolean equals(Object that) {
        ...
        TDgapAlertConfig other = (TDgapAlertConfig) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getNeedSendAlert() == null ? other.getNeedSendAlert() == null : this.getNeedSendAlert().equals(other.getNeedSendAlert()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getNeedSendAlert() == null) ? 0 : getNeedSendAlert().hashCode());
