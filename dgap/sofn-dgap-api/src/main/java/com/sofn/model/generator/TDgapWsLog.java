...
public class TDgapWsLog extends BaseModel {
    ...
    public String toString() {
        ...
        sb.append(", invokeStartDate=").append(invokeStartDate);
        sb.append(", invokeEndDate=").append(invokeEndDate);
    ...
    public boolean equals(Object that) {
        ...
        TDgapWsLog other = (TDgapWsLog) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getInvokeStartDate() == null ? other.getInvokeStartDate() == null : this.getInvokeStartDate().equals(other.getInvokeStartDate()))
            && (this.getInvokeEndDate() == null ? other.getInvokeEndDate() == null : this.getInvokeEndDate().equals(other.getInvokeEndDate()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getInvokeStartDate() == null) ? 0 : getInvokeStartDate().hashCode());
        result = prime * result + ((getInvokeEndDate() == null) ? 0 : getInvokeEndDate().hashCode());
