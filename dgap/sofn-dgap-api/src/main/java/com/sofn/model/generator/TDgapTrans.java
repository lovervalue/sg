...
public class TDgapTrans extends BaseModel {
    private String resourceId;

    private String metaid;

    private String dispatcherornot;
    ...
    public String getDispatcherornot() {
        return dispatcherornot;
    }

    public void setDispatcherornot(String dispatcherornot) {
        this.dispatcherornot = dispatcherornot == null ? null : dispatcherornot.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", dispatcherornot=").append(dispatcherornot);
    ...
    public boolean equals(Object that) {
        ...
        TDgapTrans other = (TDgapTrans) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getResourceId() == null ? other.getResourceId() == null : this.getResourceId().equals(other.getResourceId()))
            && (this.getMetaid() == null ? other.getMetaid() == null : this.getMetaid().equals(other.getMetaid()))
            && (this.getDispatcherornot() == null ? other.getDispatcherornot() == null : this.getDispatcherornot().equals(other.getDispatcherornot()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDispatcherornot() == null) ? 0 : getDispatcherornot().hashCode());
