...
public class TDgapAlertReceipt extends BaseModel {
    ...
    public boolean equals(Object that) {
        ...
        TDgapAlertReceipt other = (TDgapAlertReceipt) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getAlertId() == null ? other.getAlertId() == null : this.getAlertId().equals(other.getAlertId()))
            && (this.getReceiptBy() == null ? other.getReceiptBy() == null : this.getReceiptBy().equals(other.getReceiptBy()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getReceiptBy() == null) ? 0 : getReceiptBy().hashCode());
