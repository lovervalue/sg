package com.sofn.core.generator.plugin;
...
public class MapperPlugin extends PluginAdapter {
	...
	private static final String DEFAULT_DAO_SUPER_CLASS = "com.sofn.core.base.BaseMapper";
		...
		for (GeneratedJavaFile javaFile : introspectedTable.getGeneratedJavaFiles()) {
			...
			if (shortName.endsWith("Mapper")) { // 扩展Mapper
				if (stringHasValue(expandDaoTargetPackage)) {
					...
					mapperInterface.addAnnotation("@MyBatisDao");
					mapperInterface.setVisibility(JavaVisibility.PUBLIC);
					mapperInterface.addJavaDocLine("/**");
					mapperInterface.addJavaDocLine(" * " + shortName + "扩展");
					mapperInterface.addJavaDocLine(" */");
					mapperInterface.addImportedType(new FullyQualifiedJavaType("com.sofn.core.annotation.MyBatisDao"));
