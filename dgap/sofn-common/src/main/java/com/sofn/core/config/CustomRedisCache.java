 ...
 * @project: sofn
 * @author: wjc
 * @description: 自定义redis 缓存redis设置失效时间失败问题
 */
public class CustomRedisCache implements Cache {
     ...
     * @param expiration
     */
    public CustomRedisCache(String name, byte[] prefix, RedisOperations<? extends Object, ? extends Object> redisOperations,
                            long expiration) {
    ...
    static abstract class AbstractRedisCacheCallback<T> implements RedisCallback<T> {
        ...
        protected void processKeyExpiration(RedisCacheElement element, RedisConnection connection) {
            // 解决在 sync = true 情况下 未设置过期时间bug
            connection.expire(element.getKeyBytes(), this.cacheMetadata.defaultExpiration);
    ...
    static class RedisCacheCleanByKeysCallback extends LockingRedisCacheCallback<Void> {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.redis.cache.LockingRedisCacheCallback#doInLock(org.springframework.data.redis.connection.RedisConnection)
         */
        @Override
    ...
    static class RedisCacheEvictCallback extends AbstractRedisCacheCallback<Void> {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.redis.cache.AbstractRedisCacheCallback#doInRedis(org.springframework.data.redis.cache.RedisCacheElement, org.springframework.data.redis.connection.RedisConnection)
         */
        @Override
    ...
    static class RedisCachePutCallback extends AbstractRedisCacheCallback<Void> {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.redis.cache.AbstractRedisPutCallback#doInRedis(org.springframework.data.redis.cache.RedisCacheElement, org.springframework.data.redis.connection.RedisConnection)
         */
        @Override
        public Void doInRedis(BinaryRedisCacheElement element, RedisConnection connection) throws DataAccessException {
