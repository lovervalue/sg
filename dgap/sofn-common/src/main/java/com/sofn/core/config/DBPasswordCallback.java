...
public final class DBPasswordCallback extends DruidPasswordCallback {
    private static final byte[] key = {9, -1, 0, 5, 39, 8, 6, 19};
    private static final long serialVersionUID = -1169637324702430803L;
    ...
    public static void main(String[] args) {
        String encrypt = SecurityUtil.encryptDes("1234", key);
