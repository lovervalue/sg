...
public class XmlUtil {
	 ...
	 * @return outDto 返回Dto
	 */
	public static Map parseXml2DtoBasedNode(String pStrXml) {
		Map map = new HashMap();
	 ...
	 * @return outDto 返回Dto
	 */
	public static Map parseXml2DtoDocument(String pStrXml) {
		Map map = new HashMap();
		String strTitle = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";
		Document document = null;
		try {
	 ...
	 * @return outDto 返回Dto
	 */
	public static Map parseXml2DtoBasedNode(String pStrXml, String pXPath) {
		Map map = new HashMap();
		String strTitle = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";
		Document document = null;
		try {
	 ...
	 * @return outDto 返回Dto
	 */
	public static Map parseXml2DtoBasedProperty(String pStrXml, String pXPath) {
		Map map = new HashMap();
		String strTitle = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";
		Document document = null;
		try {
	 ...
	 * @return string 返回XML格式字符串
	 */
	public static String parseDto2Xml(Map map, String pRootNodeName, String pFirstNodeName) {
		Document document = DocumentHelper.createDocument();
		// 增加一个根元素节点
		document.addElement(pRootNodeName);
		Element root = document.getRootElement();
