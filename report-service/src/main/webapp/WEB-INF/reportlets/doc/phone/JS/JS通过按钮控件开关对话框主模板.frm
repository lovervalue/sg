...
<![CDATA[FR.mobilePopup({
	...
	parameters: {},
	setting: {
		templatePath: "/doc/phone/JS/JS通过按钮控件开关对话框子模板.frm",
		border: {
			type: 0,
			color: "rgb(0,0,0)",
			borderRadius: 4.0
...
<WidgetID widgetID="c513b412-1e88-40db-8465-5ab7e8830645"/>
<WidgetAttr description="">
<MobileBookMark useBookMark="false" bookMarkName="button0" frozen="false"/>
<PrivilegeControl/>
</WidgetAttr>
<Text>
<![CDATA[点击打开子报表弹窗]]></Text>
</InnerWidget>
<BoundsAttr x="85" y="13" width="280" height="62"/>
</Widget>
...
<TemplateIdAttMark TemplateId="5ddeae17-0718-4edf-9b41-739862d56002"/>
</TemplateIdAttMark>
</Form>
