...
<![CDATA[function time() {
    timer = setTimeout(function() {
        window.location.href = FR.cjkEncode("${contextPath}/decision/view/form?viewlet=doc/JS/表单JS实例/01-JS实现暂停和继续轮播frm报表1.frm"); //要轮播的报表url
    }, 2000); //轮播间隔
}
...
<TemplateIdAttMark TemplateId="a49fa8e3-9348-434c-9ac5-1e9ab955375b"/>
</TemplateIdAttMark>
</Form>
