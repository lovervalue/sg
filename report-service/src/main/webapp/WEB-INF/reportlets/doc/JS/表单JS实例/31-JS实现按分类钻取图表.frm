...
<Content>
<![CDATA[var iframe = $("<iframe id='001' name='001' width='100%' height='100%' scrolling='yes' frameborder='0'>") // iframe参数的命名及宽高等
...
<ChartDefinition>
<OneValueCDDefinition valueName="营收" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[Embedded1]]></Name>
</TableData>
<CategoryName value="统计类别"/>
...
<Content>
<![CDATA[var iframe = $("<iframe id='001' name='001' width='100%' height='100%' 
scrolling='yes' frameborder='0'>") // iframe参数的命名及宽高等
if (wd == '产品') {    //判断点击到的点，根据所选纬度弹出明细对话框
 iframe.attr("src", "report?viewlet=公司回款额.cpt&op=view&jd=" + jd + "")
} else if (wd == '纬度2') {    
...
<TemplateIdAttMark TemplateId="2e120a6c-40a3-4863-bd43-7e483e3881a9"/>
</TemplateIdAttMark>
</Form>
