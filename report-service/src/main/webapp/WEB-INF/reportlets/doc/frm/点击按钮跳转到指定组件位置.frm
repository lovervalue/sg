...
<Parameters/>
<Content>
<![CDATA[var a=document.getElementsByClassName('fr-titlelayout ui-state-enabled')[2]A;
a.setAttribute('id','Chart2');//如果图表块每次刷新生产的id都是不同的，那么需要先获取到图表对象，然后给他设置一个固定的id再进行跳转
document.getElementById('Chart2').scrollIntoView();//REPORT1为对应组件的id]]></Content>
</JavaScript>
</Listener>
...
<Text>
<![CDATA[点击跳转到轮播指标卡]]></Text>
</InnerWidget>
<BoundsAttr x="2" y="23" width="134" height="33"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<SubChart class="com.fr.plugin.chart.kpi.KPIChart" pluginID="com.fr.plugin.bigScreen.v10">
...
<attr names="产品" title="产品" values="销量" values_function="com.fr.data.util.function.SumFunction" customName="false"/>
</AbstractDataConfig>
</DataSet>
<ETitle>
...
<BoundsAttr x="2" y="959" width="457" height="336"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="112" foreground="-236032"/>
</Attr>
</TextAttr>
...
<UUID uuid="0dd34256-11ef-4e7e-b061-7da9f17ac96b"/>
...
<BoundsAttr x="2" y="509" width="457" height="358"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<UUID uuid="60486958-1fbd-4ad7-8399-f3480a53d58a"/>
<tools hidden="true" sort="false" export="false" fullScreen="false"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy"/>
<from>
...
<BoundsAttr x="2" y="80" width="457" height="358"/>
</Widget>
<ShowBookmarks showBookmarks="true"/>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<BoundsAttr x="0" y="0" width="1980" height="1080"/>
</Widget>
<ShowBookmarks showBookmarks="true"/>
<Sorted sorted="false"/>
<MobileWidgetList/>
...
<TemplateIdAttMark TemplateId="2c15aa48-de80-43ca-afdf-ac531285e6ce"/>
</TemplateIdAttMark>
</Form>
