...
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[市,,.,,销量]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.String]]></ColumnTypes>
<RowData ColumnTypes="java.lang.String,java.lang.String">
<![CDATA[HeLR[af[KsG;O:X)&R<US%dhBP_C6O.?O:u]ADq-hGp&\5OS<j&kL3^R+J&mq2kf8#do*D6;k
Uk8CS<3e9gL6JT5@m;<bZ:K!!~
]]></RowData>
</TableData>
</TableDataMap>
<FormMobileAttr>
...
<WidgetName name="quyu"/>
<LabelName name="下钻区域名"/>
<WidgetAttr description="">
<MobileBookMark useBookMark="false" bookMarkName="" frozen="false"/>
<PrivilegeControl/>
</WidgetAttr>
<Dictionary class="com.fr.data.impl.TableDataDictionary">
<FormulaDictAttr kiName="区域" viName="区域"/>
<TableDataDictAttr>
...
<BoundsAttr x="450" y="16" width="84" height="30"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<Parameters/>
<Content>
<![CDATA[var charts=FR.Chart.WebUtils.getChart("chart0").vanCharts.charts[0]A;
...
for(var i=0;i<len;i++){
        if(areas[i]A.name==quyu){
                charts.drillDown(areas[i]A);
                break;
        }
}]]></Content>
</JavaScript>
...
<![CDATA[根据区域名下钻]]></Text>
<initial>
<Background name="ColorBackground" color="-12080918"/>
</initial>
<over>
<Background name="ColorBackground" color="-11561007"/>
</over>
<click>
<Background name="ColorBackground" color="-12080918"/>
</click>
...
<BoundsAttr x="671" y="16" width="135" height="30"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="357" y="16" width="93" height="30"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click">
...
<BoundsAttr x="555" y="16" width="93" height="30"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.TextEditor">
<WidgetName name="weidu"/>
<LabelName name="纬度"/>
<WidgetAttr description="">
<MobileBookMark useBookMark="false" bookMarkName="" frozen="false"/>
<PrivilegeControl/>
...
<BoundsAttr x="260" y="16" width="80" height="30"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="180" y="16" width="80" height="30"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="7" y="16" width="80" height="30"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.TextEditor">
<WidgetName name="jingdu"/>
<LabelName name="经度"/>
<WidgetAttr description="">
<MobileBookMark useBookMark="false" bookMarkName="" frozen="false"/>
<PrivilegeControl/>
...
<BoundsAttr x="87" y="16" width="80" height="30"/>
</Widget>
<ShowBookmarks showBookmarks="false"/>
<Sorted sorted="false"/>
<MobileWidgetList>
<Widget widgetName="jingdu"/>
<Widget widgetName="weidu"/>
<Widget widgetName="quyu"/>
...
<NameTagModified/>
<WidgetNameTagMap>
<NameTag name="weidu" tag="纬度"/>
<NameTag name="jingdu" tag="经度"/>
<NameTag name="quyu" tag="下钻区域名"/>
</WidgetNameTagMap>
...
<ViewCenter auto="true" longitude="120.0" latitude="33.0"/>
...
<UUID uuid="50b9a34d-a5d0-465f-a216-85b426fc126b"/>
...
<VanChartMapPlotAttr mapType="area" geourl="assets/map/geographic/中国(省级).json" zoomlevel="5" mapmarkertype="0" nullvaluecolor="-3355444"/>
<lineMapDataProcessor>
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
</lineMapDataProcessor>
<GisLayer>
...
<UUID uuid="79806792-a50e-4d3c-9daa-03d1894fe9e2"/>
<tools hidden="true" sort="false" export="false" fullScreen="false"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy"/>
<from>
...
<TemplateIdAttMark TemplateId="685b8dc0-9bc6-493f-be40-27ea1d8b1d43"/>
</TemplateIdAttMark>
</Form>
