...
<Parameters/>
<Content>
<![CDATA[var vanchart=FR.Chart.WebUtils.getChart("chart0").getChartWithIndex(2);//获取chart0控件的第三个图表，即折线图
vanchart.setSeriesVisible([2,3]A);//显示折线图的系列3和系列4]]></Content>
</JavaScript>
</Listener>
<WidgetName name="button2"/>
<WidgetAttr description="">
<MobileBookMark useBookMark="false" bookMarkName="button2" frozen="false"/>
<PrivilegeControl/>
</WidgetAttr>
<Text>
<![CDATA[折线图中系列3和4可见，图例不可见]]></Text>
<initial>
...
<BoundsAttr x="693" y="458" width="265" height="80"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click">
...
<Parameters/>
<Content>
<![CDATA[var vanchart=FR.Chart.WebUtils.getChart("chart0").getChartWithIndex(1);//获取chart0控件的第二个图表，即条形图
vanchart.setSeriesVisible();//显示条形图的系列，此处没有参数，即不显示]]></Content>
</JavaScript>
</Listener>
...
<BoundsAttr x="342" y="458" width="351" height="80"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click">
...
<Parameters/>
<Content>
<![CDATA[var vanchart=FR.Chart.WebUtils.getChart("chart0").getChartWithIndex(0);//获取chart0控件的第一个图表，即柱形图
vanchart.setSeriesVisible([0,1]A);//显示柱形图的系列1和系列2]]></Content>
</JavaScript>
</Listener>
...
<Text>
<![CDATA[柱形图中系列1和2可见]]></Text>
<initial>
<Background name="ColorBackground" color="-26164"/>
</initial>
<over>
<Background name="ColorBackground" color="-65281"/>
</over>
<click>
...
<BoundsAttr x="0" y="458" width="342" height="80"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<UUID uuid="d969ce77-bf63-48ff-9bf4-a357424c23f7"/>
...
<UUID uuid="e84380da-2de7-46d8-ac29-3826e6f14852"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy"/>
<from>
...
<UUID uuid="edf870ee-680d-40d5-8584-03b0e62da798"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy"/>
<from>
...
<BoundsAttr x="0" y="0" width="958" height="458"/>
</Widget>
<ShowBookmarks showBookmarks="false"/>
...
<CategoryName value=""/>
<ChartSummaryColumn name="2011" function="com.fr.data.util.function.NoneFunction" customName="2011"/>
<ChartSummaryColumn name="2010" function="com.fr.data.util.function.NoneFunction" customName="2010"/>
<ChartSummaryColumn name="2009" function="com.fr.data.util.function.NoneFunction" customName="2009"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<UUID uuid="9e54e9aa-8b8d-46e7-9732-3616e0f1889c"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy"/>
<from>
...
<UUID uuid="59ebabb9-8506-42b2-87af-0bbe64a9ab93"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy"/>
<from>
...
<UUID uuid="fb192483-911e-47e7-a4c7-2041bdaf109e"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy"/>
<from>
...
<TemplateIdAttMark TemplateId="9e6cc48a-df29-45a2-befc-5bec44be6439"/>
</TemplateIdAttMark>
</Form>
