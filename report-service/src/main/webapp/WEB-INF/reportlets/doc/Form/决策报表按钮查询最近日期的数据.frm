...
<![CDATA[SELECT * FROM 订单 where 1=1 
 ...
 ${if(len(endtime)=0,""," and 订购日期<='"+endtime+"'")}]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
</TableDataMap>
...
<Parameters/>
<Content>
<![CDATA[var K1='${=date(2011,6,22)-14}';//定义开始时间
//alert(K1);
_g().getWidgetByName("starttime").setValue(K1);//把K1值赋给开始时间控件
_g().getWidgetByName("starttime").fireEvent("afteredit");//触发开始控件的编辑后事件]]></Content>
</JavaScript>
</Listener>
...
<BoundsAttr x="541" y="29" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="212" y="29" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<Parameters/>
<Content>
<![CDATA[var K1='${=date(2011,6,22)-7}';//定义开始时间
//alert(K1);
_g().getWidgetByName("starttime").setValue(K1);//把K1值赋给开始时间控件
_g().getWidgetByName("starttime").fireEvent("afteredit");//触发开始控件的编辑后事件]]></Content>
</JavaScript>
...
<BoundsAttr x="436" y="29" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<widgetValue>
<O t="Date">
<![CDATA[1308672000000]]></O>
</widgetValue>
</InnerWidget>
<BoundsAttr x="292" y="29" width="108" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.DateEditor">
...
<widgetValue>
<O t="Date">
<![CDATA[1305993600000]]></O>
</widgetValue>
</InnerWidget>
<BoundsAttr x="80" y="29" width="108" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<CategoryName value="订购日期"/>
<ChartSummaryColumn name="应付金额" function="com.fr.data.util.function.SumFunction" customName="应付金额"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<UUID uuid="a6e2eb7f-f9da-4587-bb3a-875b76209e17"/>
...
<BoundsAttr x="0" y="78" width="1019" height="570"/>
</Widget>
<ShowBookmarks showBookmarks="true"/>
<Sorted sorted="true"/>
<MobileWidgetList>
