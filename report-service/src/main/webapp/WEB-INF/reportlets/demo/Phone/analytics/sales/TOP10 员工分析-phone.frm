...
<Query>
<![CDATA[SELECT  strftime('%m',S订单.订购日期) as 月份,sum(单价*数量*(1-折扣)) as 销售额
FROM S订单,S订单明细,S雇员
where S订单.雇员ID=S雇员.雇员ID and S订单.订单ID=S订单明细.订单ID and strftime('%Y',S订单.订购日期)='${nian}' and S雇员.姓氏||S雇员.名字='${name}'
group by strftime('%m',S订单.订购日期)]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<BoundsAttr x="90" y="22" width="229" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="10" y="22" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="344" y="22" width="80" height="21"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<O>
<![CDATA[=$name+\'每月回款率\']]></O>
<FRFont name="Verdana" style="0" size="80" foreground="-12303292"/>
<Position pos="2"/>
...
<BoundsAttr x="0" y="0" width="373" height="335"/>
</Widget>
...
<BoundsAttr x="0" y="311" width="373" height="335"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<ChartSummaryColumn name="字段" function="com.fr.data.util.function.SumFunction" customName="销售/回款额"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
...
<BoundsAttr x="0" y="36" width="373" height="275"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="0" width="373" height="311"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[=$name+'客户资源质量占比']]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="Adobe Arabic" style="0" size="72" foreground="-12759706"/>
</Attr>
</TextAttr>
<TitleVisible value="true" position="0"/>
</Title>
...
<Attr4VanChart floating="false" x="5.0" y="85.0" limitSize="false" maxHeight="15.0" isHighlight="true"/>
</Legend4VanChart>
<DataSheet>
<GI>
<AttrBackground>
...
<VanChartRadius radiusType="auto" radius="60"/>
</Plot>
<ChartDefinition>
...
<BoundsAttr x="188" y="0" width="185" height="221"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
...
<BoundsAttr x="188" y="646" width="185" height="221"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="chart3"/>
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[=$name+'员工订单在总额比重']]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="Adobe Arabic" style="0" size="72" foreground="-12759706"/>
...
<BoundsAttr x="0" y="0" width="188" height="221"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart3"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="646" width="188" height="221"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[=$name+'按月统计订单金额']]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="Adobe Arabic" style="0" size="96" foreground="-12759706"/>
...
<Attr class="com.fr.plugin.chart.base.VanChartAttrMarker">
<VanAttrMarker>
<Attr isCommon="true" markerType="NullMarker" radius="4.0" width="30.0" height="30.0"/>
<Background name="NullBackground"/>
</VanAttrMarker>
</Attr>
...
<BoundsAttr x="0" y="0" width="373" height="330"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart1"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="867" width="373" height="330"/>
</Widget>
<Sorted sorted="true"/>
<MobileWidgetList>
...
<TemplateIdAttMark TemplateId="33914e8c-5c1e-444e-8f30-d5b7b6badf42"/>
</TemplateIdAttMark>
</Form>
